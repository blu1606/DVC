  ...
  try {
    ...
    if (domSnapshot && domSnapshot.status === "success") {
      ...
      session.sendMessage(
        ...
        `Hãy chào bác một cách thân thiện (dành cho người cao tuổi Việt Nam), cho bác biết bác đang ở trang nào, và hỏi bác muốn làm thủ tục gì hoặc cần cháu giúp phần nào. Không gọi công cụ nào ở lượt chào đầu tiên này.`
      );
    }
  } catch (err) {
